...
def objective(trial):
    ...
    model = LitModel_supervised_pretrain(args, f"log-pretrain/unsupervised_hyp_tuning/checkpoints", max_steps=300000)
...
if __name__ == '__main__':
    ...
    # study.optimize(objective_fine_tune, n_trials=25, n_jobs=1)
    lrs = [0.002, 0.0005]
    wds = [1e-6, 1e-5, 1e-4]
